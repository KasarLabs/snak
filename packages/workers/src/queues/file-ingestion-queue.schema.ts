...
export const FileIngestionJobPayloadSchema = z.object({
  ...
  (data) => data.buffer.length === data.size,
  {
...
export type FileIngestionJobPayload = z.infer<typeof FileIngestionJobPayloadSchema>;

export function validateFileIngestionPayload(payload: unknown): FileIngestionJobPayload {
  try {
