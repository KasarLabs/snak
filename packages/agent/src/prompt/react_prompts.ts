...
**Action**: Take a specific action (either use a tool or provide a final answer).
...
- Use **Action** to either call tools or provide final answers
...
1. **Tool Usage**: When you need to gather information or perform operations
   - Use available tools with proper parameters
