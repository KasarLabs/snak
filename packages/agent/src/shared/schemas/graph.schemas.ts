...
export const messageAskUserSchema = z.object({
  type: z.literal('function'),
  function: z.object({
    name: z.literal('message_ask_user'),
    ...
    parameters: z.object({
      ...
      properties: z.object({
        ...
        suggest_user_takeover: z.object({
          type: z.literal('string'),
          enum: z.tuple([z.literal('none'), z.literal('browser')]),
          description: z.string(),
        }),
      }),
...
export type MessageAskUser = z.infer<typeof messageAskUserSchema>;
